...
bool aes256_detect_decB(const unsigned int *data) {
	...
	roundkey[4] = setup_mix(reverse(data[52]));
	roundkey[5] = setup_mix(reverse(data[53]));
	roundkey[6] = setup_mix(reverse(data[54]));
	roundkey[7] = setup_mix(reverse(data[55]));
